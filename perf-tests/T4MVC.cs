...
{
    public static MvcPerfTest.Controllers.HomeController Home = new MvcPerfTest.Controllers.T4MVC_HomeController();
    public static MvcPerfTest.Controllers.TestsController Tests = new MvcPerfTest.Controllers.T4MVC_TestsController();
